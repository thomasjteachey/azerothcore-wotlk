...
void ObjectMgr::LoadScriptNames()
{
    ...
    QueryResult result = WorldDatabase.Query(
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci FROM achievement_criteria_data WHERE ScriptName <> '' AND type = 11 "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci FROM battleground_template WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci FROM creature WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci FROM creature_template WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM gameobject WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM gameobject_template WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM item_template WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM areatrigger_scripts WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM spell_script_names WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM transports WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM game_weather WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM conditions WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(ScriptName) COLLATE utf8mb4_unicode_ci  FROM outdoorpvp_template WHERE ScriptName <> '' "
                             "UNION "
                             "SELECT DISTINCT(script) COLLATE utf8mb4_unicode_ci  FROM instance_template WHERE script <> ''");
